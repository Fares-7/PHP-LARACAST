    ...
    <div class="max-w-xl mx-auto py-8">
        ...
        <form method="POST">
            <div class="mb-4">
                ...
                <input type="text" name="title" class="w-full border px-3 py-2 rounded" value="<?= htmlspecialchars($_POST['title'] ?? '') ?>">
            </div>
            <div class="mb-4">
                <label class="block mb-1">Content</label>
                <textarea name="content" class="w-full border px-3 py-2 rounded" rows="6"><?= htmlspecialchars($_POST['content'] ?? '') ?></textarea>
            </div>
